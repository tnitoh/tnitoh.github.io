...
独立研究者としての活動のほか、下記のような案件（詳細は「専門分野」を参照）に対するコンサルティング、講演・執筆をおこなっています。
...
- 海外企業にて画像診断用**フォトンカウンティングCT**の研究開発業務に従事（2010年〜）。
...
- 研究者倫理・研究における不正行為防止に関する教育。[[Note]](research_ethics.md)

## 職歴
- 〜2001年9月: 株式会社日立メディコ CT事業部設計部（計測システムアーキテクト）
- ～2024年7月: シーメンスヘルスケア株式会社 / Siemens Healthineers CT-R&D（チーフサイエンティスト）
