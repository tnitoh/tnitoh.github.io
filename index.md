...
- 国内外の企業でX線CT装置の開発に30年以上、そして2010年からはフォトンカウンティングCTの研究開発に従事。また、国内の様々な大学医学部にて学術研究の指導経験あり（20年以上）。医療行政や医療機器周辺の知見、ネットワークも豊富。学会・研究会などでの講演、大学講義、雑誌媒体等への依頼執筆などもおこなっている。

## 専門
- X線CT装置における計測制御やデータ補正処理全般。なかでも得意分野は下記のような領域。
...
- 医学・工学研究に関して、立案から実践（学会発表、論文発表を含む）までの総合的なマネージメント、およびその指導の経験が豊富。
