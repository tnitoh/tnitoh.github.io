...
医用画像・物理工学の研究者（Ph.D.）。専門はX線CTの物理・シミュレーション・検出器物理物性・計測データプロセッシング・画像再構成・スペクトラルイメージングなど。現在はフォトンカウンティングCTの研究に従事。
...
- 2023年4月15日: 「フォトンカウンティングCTの技術」 [医学放射線学会総会](https://site2.convention.co.jp/jrs82/){:target="_blank"}（神奈川県横浜市）
- 2023年7月28日: 「フォトンカウンティングCT」[日本医用画像工学会総会](http://jamit.jp/meetinginfo/index.html){:target="_blank"}（大阪府吹田市）
